...
registrationLink: '#',
  ...
  },
  {
    ...
    status: 'published',
    themes: [
      { title: '18/09 - RESTAURANTE INTELIGENTE — Como transformar a Inteligência Artificial em uma equipe que trabalha com você' },
      { title: '19/09 - Reforma Tributária na prática: da contabilidade ao sistema' },
    ],
    about: '',
    learningTopics: [],
    consultants: [],
    schedule: [],
    partners: [
      { name: 'Alberto Kastro\nEspecialista em Inteligência Artificial', logo: '/assets/consultants/alberto-kastro.png' },
      { name: 'Cruz - Assessoria Empresarial\nContabilidade e gestão empresarial', logo: '/assets/consultants/cruz-assessoria.jpeg' },
      { name: 'Soft3\nSistemas de gestão empresarial em nuvem', logo: '/assets/consultants/soft3.jpg' },
    ],
    partnerStatus: 'closed',
    registrationLink: '#',
  },
